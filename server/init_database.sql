...
('Ablo (Gâteaux de Riz à la Vapeur)', 
 ...
 95, 'Moyen', 1, true, 0, 'ablo.png', 1, 1, CURRENT_TIMESTAMP),
...
('Pignon (Gari avec Sauce Tomate)', 
 ...
 40, 'Facile', 1, true, 0, 'pinion.png', 1, 1, CURRENT_TIMESTAMP),
...
('Œufs Frits à l''Africaine', 
 ...
 12, 'Facile', 1, true, 0, 'oeuf.png', 3, 1, CURRENT_TIMESTAMP),
...
('Sauce Mouton/Tripes (Sauce Rouge aux Abats)', 
 ...
 120, 'Difficile', 1, true, 0, 'sauce_tripes_boeuf.png', 1, 1, CURRENT_TIMESTAMP),
...
('Riz au Gras Rouge (Jollof Rice)', 
 ...
 55, 'Moyen', 1, true, 0, 'riz_aux_gras_rouge.jpg', 3, 1, CURRENT_TIMESTAMP),

-- 14. RIZ AU GRAS BLANC
('Riz au Gras Blanc', 
 'Riz cuisiné avec légumes et bouillon, version blanche du riz au gras', 
 35, 'Facile', 1, true, 0, 'riz_aux_gras_blanc.jpg', 3, 1, CURRENT_TIMESTAMP),
...
('Pâtes Coquillages (Salade de Pâtes)', 
 ...
 22, 'Facile', 1, true, 0, 'salade_coquillage.jpg', 3, 1, CURRENT_TIMESTAMP),
...
('Yaourt / Lait Caillé (Kossam)', 
 ...
 490, 'Moyen', 1, true, 0, 'yaourt.png', 3, 1, CURRENT_TIMESTAMP);
...
SELECT 
    ...
    COUNT(DISTINCT e.ordre) AS "nb_etapes",
